 ...
 * 
 * NOTE: This module uses Node.js APIs (child_process, fs) and should only
 * be imported from server-side code. The functions will gracefully fail
 * if called from client-side code.
 */

...
export async function POST(request: NextRequest, { params }: RouteParams) {
  ...
  // Check for patient:write permission (required for FHIR write operations)
  if (!authResult.user!.permissions.includes("patient:write")) {
    return NextResponse.json(
      {
        resourceType: "OperationOutcome",
        issue: [
...
export async function DELETE(request: NextRequest, { params }: RouteParams) {
  ...
  // Check for patient:delete permission (required for FHIR delete operations)
  if (!authResult.user!.permissions.includes("patient:delete")) {
    return NextResponse.json(
      {
        resourceType: "OperationOutcome",
        issue: [

  ...
  try {
    ...
    const patient = await db.patient.create({
      data: {
        ...
        nationalHealthId: validatedData.nationalHealthId,
        nationalIdType: validatedData.nationalIdType,
        biometricId: validatedData.biometricId,
        facialRecognitionId: validatedData.facialRecognitionId,
        smartCardSerialNumber: validatedData.smartCardSerialNumber,
        ...
        emergencyContact2Name: validatedData.emergencyContact2Name,
        emergencyContact2Phone: validatedData.emergencyContact2Phone,
        emergencyContact2Relation: validatedData.emergencyContact2Relation,
        allergies: validatedData.allergies,
        allergyCritical: validatedData.allergyCritical,
        organDonorStatus: validatedData.organDonorStatus,
        pregnancyStatus: validatedData.pregnancyStatus,
        chronicConditions: validatedData.chronicConditions,
        implantedDevices: validatedData.implantedDevices,
        fallRisk: validatedData.fallRisk,
        fallRiskLevel: validatedData.fallRiskLevel,
        infectiousDiseaseStatus: validatedData.infectiousDiseaseStatus,
        infectionIsolationType: validatedData.infectionIsolationType,
        dnrOrder: validatedData.dnrOrder,
        dnrOrderPhysician: validatedData.dnrOrderPhysician,
        isolationPrecautions: validatedData.isolationPrecautions,
        highRiskMedications: validatedData.highRiskMedications,
        suicideRisk: validatedData.suicideRisk,
        elopementRisk: validatedData.elopementRisk,
        languagePrimary: validatedData.languagePrimary,
        languageSecondary: validatedData.languageSecondary,
        interpreterNeeded: validatedData.interpreterNeeded,
        religion: validatedData.religion,
        religiousConsiderations: validatedData.religiousConsiderations,
        disabilityStatus: validatedData.disabilityStatus,
        mobilityStatus: validatedData.mobilityStatus,
        mobilityAid: validatedData.mobilityAid,
        caregiverName: validatedData.caregiverName,
        caregiverPhone: validatedData.caregiverPhone,
        caregiverRelation: validatedData.caregiverRelation,
        advanceDirective: validatedData.advanceDirective,
        advanceDirectiveLocation: validatedData.advanceDirectiveLocation,
        healthcareProxyName: validatedData.healthcareProxyName,
        healthcareProxyPhone: validatedData.healthcareProxyPhone,
        lastPhysicianName: validatedData.lastPhysicianName,
        lastPhysicianSpecialty: validatedData.lastPhysicianSpecialty,
        primaryCarePhysician: validatedData.primaryCarePhysician,
        primaryCareFacility: validatedData.primaryCareFacility,
        triagePriority: validatedData.triagePriority,
        totalAdmissions: validatedData.totalAdmissions,
        totalEdVisits: validatedData.totalEdVisits,
        insurancePrimary: validatedData.insurancePrimary,
        insurancePrimaryId: validatedData.insurancePrimaryId,
        insurancePrimaryGroup: validatedData.insurancePrimaryGroup,
        insuranceSecondary: validatedData.insuranceSecondary,
        insuranceSecondaryId: validatedData.insuranceSecondaryId,
        insuranceVerified: validatedData.insuranceVerified,
        aiRiskScore: validatedData.aiRiskScore,
        aiRiskLevel: validatedData.aiRiskLevel,
        aiRiskFactors: validatedData.aiRiskFactors,
        aiReadmissionRisk: validatedData.aiReadmissionRisk,
        aiMortalityRisk: validatedData.aiMortalityRisk,
        aiTriagePrediction: validatedData.aiTriagePrediction,
        aiEmergencyAlerts: validatedData.aiEmergencyAlerts,
        aiPopulationHealthTag: validatedData.aiPopulationHealthTag,
        nfcEnabled: validatedData.nfcEnabled,
        rfidTagId: validatedData.rfidTagId,
        digitalAccessEnabled: validatedData.digitalAccessEnabled,
        patientPortalAccess: validatedData.patientPortalAccess,
        fingerprintRegistered: validatedData.fingerprintRegistered,
        fingerprintTemplateId: validatedData.fingerprintTemplateId,
        irisScanRegistered: validatedData.irisScanRegistered,
        irisScanTemplateId: validatedData.irisScanTemplateId,
        voicePrintRegistered: validatedData.voicePrintRegistered,
        voicePrintTemplateId: validatedData.voicePrintTemplateId,
        patientPhoto: validatedData.patientPhoto,
        isActive: validatedData.isActive,
        mrn,
        patientDigitalId,
        qrCodeData,
        dateOfBirth: new Date(validatedData.dateOfBirth),
        estimatedDueDate: validatedData.estimatedDueDate ? new Date(validatedData.estimatedDueDate) : undefined,
        dnrOrderDate: validatedData.dnrOrderDate ? new Date(validatedData.dnrOrderDate) : undefined,
        lastHospitalVisit: validatedData.lastHospitalVisit ? new Date(validatedData.lastHospitalVisit) : undefined,
        insuranceVerifiedDate: validatedData.insuranceVerifiedDate ? new Date(validatedData.insuranceVerifiedDate) : undefined,
        aiLastAssessment: validatedData.aiLastAssessment ? new Date(validatedData.aiLastAssessment) : undefined,
        patientPortalLastAccess: validatedData.patientPortalLastAccess ? new Date(validatedData.patientPortalLastAccess) : undefined,
        cardPrintDate: validatedData.cardPrintDate ? new Date(validatedData.cardPrintDate) : undefined,
        cardExpiryDate: validatedData.cardExpiryDate ? new Date(validatedData.cardExpiryDate) : undefined,

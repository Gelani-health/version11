...
# PROMPT 6: Logger for diagnostic reasoning
...
class DiagnosticHypothesis:
    ...
    evidence_pmids: List[str] = field(default_factory=list)  # PROMPT 6: RAG citation alignment
    forced_inclusion: bool = False  # PROMPT 6: Retained critical diagnosis with low probability
    red_flag_applied: str = ""  # PROMPT 6: Which red flag keyword triggered multiplier
    age_sex_modifier_applied: str = ""  # PROMPT 6: Which modifier was applied
    ...
    def to_dict(self) -> Dict[str, Any]:
        return {
            ...
            "evidence_pmids": self.evidence_pmids,  # PROMPT 6
            "forced_inclusion": self.forced_inclusion,  # PROMPT 6
            "red_flag_applied": self.red_flag_applied,  # PROMPT 6
            "age_sex_modifier_applied": self.age_sex_modifier_applied,  # PROMPT 6
        }
...
# =============================================================================
# PROMPT 6: RED FLAG KEYWORD MULTIPLIERS
# Evidence-based multipliers for critical diagnoses based on symptom keywords
# =============================================================================
# When a red flag keyword matches the chief complaint text, multiply the 
# pre-test probability of the associated diagnosis by the specified multiplier.
#
# Reference: Perry JJ et al. BMJ 2011;343:d4277 (PMID 21835857) - thunderclap LR for SAH

RED_FLAG_MULTIPLIERS: Dict[str, Dict[str, Any]] = {
    "subarachnoid_hemorrhage": {
        "keywords": ["thunderclap", "worst headache", "worst of my life", "sudden onset", "never had before", "like being hit", "explosive"],
        "multiplier": 8.0,
        "evidence": "Perry JJ et al. BMJ 2011;343:d4277 PMID 21835857 — thunderclap LR for SAH ≈11"
    },
    "aortic_dissection": {
        "keywords": ["tearing", "ripping", "worst pain", "radiating to back", "migrating pain", "back pain chest", "stabbing"],
        "multiplier": 6.0,
        "evidence": "Hagan PG et al. JAMA 2000;283:897 PMID 10685714 — IRAD registry"
    },
    "meningitis": {
        "keywords": ["neck stiffness", "photophobia", "photophobic", "stiff neck", "cannot bend neck", "light hurts", "neck pain fever"],
        "multiplier": 5.0,
        "evidence": "van de Beek D et al. N Engl J Med 2004;351:1849 PMID 15509818"
    },
    "pulmonary_embolism": {
        "keywords": ["immobilized", "long flight", "long drive", "recent surgery", "cancer", "dvt", "clot", "leg swelling breathing", "blood clot"],
        "multiplier": 3.0,
        "evidence": "Wells PS et al. Thromb Haemost 2000;83:416 PMID 10744147"
    },
    "acute_coronary_syndrome": {
        "keywords": ["crushing", "pressure", "heaviness", "left arm", "jaw pain", "sweating chest", "diaphoresis", "radiating arm"],
        "multiplier": 3.0,
        "evidence": "Panju AA et al. JAMA 1998;280:1256 PMID 9786397"
    },
    "sepsis": {
        "keywords": ["confusion fever", "altered fever", "low blood pressure fever", "rapid heart fever", "shaking chills", "rigors"],
        "multiplier": 3.5,
        "evidence": "Seymour CW et al. JAMA 2016;315:762 PMID 26903338"
    },
    "cauda_equina_syndrome": {
        "keywords": ["cannot void", "urinary retention", "saddle anesthesia", "bowel incontinence", "leg weakness both", "numbness groin"],
        "multiplier": 8.0,
        "evidence": "Fraser S et al. Br J Hosp Med 2009;70:344 PMID 19773991"
    },
    "stroke": {
        "keywords": ["sudden weakness", "sudden numbness", "facial droop", "speech slurred", "cannot speak", "arm drift", "one side weak"],
        "multiplier": 5.0,
        "evidence": "AHA/ASA Guidelines 2019; PMID 31662097"
    },
    "ectopic_pregnancy": {
        "keywords": ["missed period pain", "pregnancy test positive pain", "vaginal bleeding pregnancy", "pelvic pain pregnancy"],
        "multiplier": 4.0,
        "evidence": "ACOG Practice Bulletin No. 193 PMID 30277083"
    },
    "testicular_torsion": {
        "keywords": ["sudden testicular pain", "testicle pain sudden", "scrotal pain sudden", "twisted testicle"],
        "multiplier": 6.0,
        "evidence": "Ringdahl E, Teague L. Am Fam Physician 2006;74:1739 PMID 17137000"
    }
}


# =============================================================================
# PROMPT 6: AGE/SEX MODIFIERS FOR DIAGNOSES
# Adjust pre-test probabilities based on patient demographics
# =============================================================================
# These modifiers apply to specific diagnoses where demographics significantly
# impact pre-test probability. Apply to base probability before normalization.

AGE_SEX_MODIFIERS: Dict[str, Dict[str, Any]] = {
    "acute_coronary_syndrome": {
        "age_brackets": {"<40": 0.3, "40-65": 1.0, ">65": 1.8},
        "sex": {"M": 1.2, "F": 0.85},  # Note: F modifier inverts at age >65 per Framingham
        "sex_age_interaction": {
            "F_over_65": 1.0  # Female risk approaches male after 65
        },
        "evidence": "Framingham Heart Study; AHA 2020 Heart Disease Statistics"
    },
    "ectopic_pregnancy": {
        "sex_gate": "F_only",
        "age_gate": [15, 50],  # Zero probability outside this age range for biological females
        "evidence": "ACOG Practice Bulletin No. 193; PMID 30277083"
    },
    "ovarian_torsion": {
        "sex_gate": "F_only",
        "age_gate": [10, 80],
        "evidence": "Dahiya N. Ultrasound Clin 2018;13:299"
    },
    "testicular_torsion": {
        "sex_gate": "M_only",
        "age_gate": [0, 60],  # Can occur at any age but most common 12-18
        "peak_age_modifier": {"12-18": 2.0},  # Peak incidence during puberty
        "evidence": "Sharp VJ et al. Am Fam Physician 2013;88:835 PMID 24364548"
    },
    "appendicitis": {
        "age_brackets": {"<40": 1.3, "40-65": 1.0, ">65": 0.7},
        "evidence": "Addiss DG et al. Ann Surg 1990 PMID 2296071"
    },
    "prostatitis": {
        "sex_gate": "M_only",
        "age_brackets": {"<30": 0.5, "30-50": 1.0, ">50": 1.5},
        "evidence": "Krieger JN et al. Urology 2008;72:1278 PMID 19028445"
    },
    "pneumonia": {
        "age_brackets": {"<5": 1.5, "5-50": 0.7, ">65": 1.8},
        "evidence": "Jain S et al. N Engl J Med 2015;373:415 PMID 26172429"
    },
    "bacterial_meningitis": {
        "age_brackets": {"<2": 2.0, "2-50": 0.7, ">65": 1.8},
        "evidence": "van de Beek D et al. N Engl J Med 2004;351:1849 PMID 15509818"
    },
    "aortic_dissection": {
        "age_brackets": {"<40": 0.3, "40-65": 1.0, ">65": 1.5},
        "sex": {"M": 1.5, "F": 0.7},
        "evidence": "Hagan PG et al. JAMA 2000;283:897 PMID 10685714"
    },
    "peptic_ulcer_disease": {
        "age_brackets": {"<40": 0.5, "40-65": 1.0, ">65": 1.5},
        "evidence": "Sung J et al. Nat Rev Gastroenterol Hepatol 2009;6:335"
    }
}


# =============================================================================
# PROMPT 6: HYPOTHESIS-TO-PMID MAPPING
# Primary evidence citations for RAG alignment
# =============================================================================
# Maps diagnosis names to their primary PubMed citations for RAG retrieval alignment.

HYPOTHESIS_PMIDS: Dict[str, List[str]] = {
    # Neurological emergencies
    "subarachnoid_hemorrhage": ["21835857"],  # Perry JJ et al. BMJ 2011
    "stroke": ["31662097"],  # AHA/ASA Guidelines 2019
    "transient_ischemic_attack": ["15304456"],  # Johnston SC et al. JAMA 2004
    "meningitis": ["15509818"],  # van de Beek D et al. NEJM 2004
    "aortic_dissection": ["10685714"],  # Hagan PG et al. JAMA 2000 (IRAD)
    
    # Cardiac emergencies
    "acute_coronary_syndrome": ["16287956"],  # Swap CJ, Nagurney JT. JAMA 2005
    "myocardial_infarction": ["15708966"],  # Thygesen K et al. Circulation 2007
    "pulmonary_embolism": ["21422387"],  # Pollack CV et al. Am J Med 2011 (PIOPED II)
    
    # Infectious diseases
    "sepsis": ["26903338"],  # Seymour CW et al. JAMA 2016
    "pneumonia": ["17278083"],  # Mandell LA et al. Clin Infect Dis 2007 (IDSA)
    "community_acquired_pneumonia": ["17278083"],  # IDSA Guidelines 2007
    
    # Gastrointestinal emergencies
    "appendicitis": ["2296071"],  # Addiss DG et al. Ann Surg 1990
    "pancreatitis": ["25327812"],  # Tenner S et al. Am J Gastroenterol 2013
    "upper_gi_bleed": ["11129245"],  # Barkun AN et al. Ann Intern Med 2003
    
    # Obstetric/Gynecologic emergencies  
    "ectopic_pregnancy": ["30277083"],  # ACOG Practice Bulletin No. 193
    "ovarian_torsion": ["29793902"],  # Sasaki KJ, Miller CE. J Minim Invasive Gynecol 2014
    
    # Urologic emergencies
    "testicular_torsion": ["24364548"],  # Ringdahl E, Teague L. Am Fam Physician 2013
    
    # Orthopedic emergencies
    "cauda_equina_syndrome": ["19773991"],  # Fraser S et al. Br J Hosp Med 2009
...
class BayesianDiagnosticEngine:
    ...
    def create_session(
        ...
        patient_context: Optional[Dict[str, Any]] = None,  # PROMPT 6: age, sex for modifiers
    ) -> DiagnosticSession:
        """
        Create a new diagnostic session with initial hypotheses.
        
        PROMPT 6 ENHANCED: Now applies red flag multipliers, age/sex modifiers,
        and populates evidence_pmids for RAG alignment.
        ...
        Args:
            ...
            patient_context: Dict with 'age' (int) and 'sex' ('M' or 'F') for modifiers
        
        Returns:
            New DiagnosticSession with initialized hypotheses
            
        Note: R69 (Unknown cause) is NEVER used as a diagnosis. If no cluster match,
        the closest cluster by keyword scoring is used instead.
        """
        ...
        # PROMPT 6: Extract patient context for modifiers
        patient_context = patient_context or {}
        patient_age = patient_context.get("age")
        patient_sex = patient_context.get("sex", "").upper()
        ...
        # PROMPT 6: NEVER use R69 fallback - use match_complaint_to_cluster instead
        # If no direct match, find closest cluster by keyword scoring
        if not hypotheses_data:
            matched_cluster = match_complaint_to_cluster(chief_complaint)
            if matched_cluster in PRE_TEST_PROBABILITIES:
                cluster_data = PRE_TEST_PROBABILITIES[matched_cluster]
                presentations = list(cluster_data.get("presentations", {}).values())
                if presentations:
                    hypotheses_data = presentations[0]
                    # Log the cluster matching for transparency
                    logger.info(f"PROMPT 6: Matched '{chief_complaint}' to cluster '{matched_cluster}'")
            ...
            for diag, prob in custom_probabilities.items():
                if diag in hypotheses_data:
                    ...
                    hypotheses_data[diag] = {
                        "prob": prob,
                        "icd": "R69",  # Custom diagnoses still use R69 as unknown
                        "critical": False,
                        "urgency": "semi_urgent"
                    }
        
        # PROMPT 6: Apply red flag multipliers and age/sex modifiers
        chief_complaint_lower = chief_complaint.lower()
        
        for diagnosis_key, data in hypotheses_data.items():
            prob = data.get("prob", 0)
            red_flag_applied = ""
            age_sex_modifier_applied = ""
            
            # Apply red flag keyword multiplier
            for flag_key, flag_data in RED_FLAG_MULTIPLIERS.items():
                if flag_key in diagnosis_key.lower() or diagnosis_key.lower() in flag_key:
                    for keyword in flag_data["keywords"]:
                        if keyword in chief_complaint_lower:
                            prob *= flag_data["multiplier"]
                            red_flag_applied = f"{keyword} (×{flag_data['multiplier']})"
                            logger.info(f"PROMPT 6: Red flag '{keyword}' matched for {diagnosis_key}, prob now {prob}")
                            break
                    if red_flag_applied:
                        break
            
            # Apply age/sex modifier
            for modifier_key, modifier_data in AGE_SEX_MODIFIERS.items():
                if modifier_key in diagnosis_key.lower() or diagnosis_key.lower() in modifier_key:
                    # Apply sex gate (e.g., ectopic pregnancy is F_only)
                    sex_gate = modifier_data.get("sex_gate")
                    if sex_gate:
                        if sex_gate == "F_only" and patient_sex != "F":
                            prob = 0.0
                            age_sex_modifier_applied = "sex_gate: F_only (probability set to 0)"
                        elif sex_gate == "M_only" and patient_sex != "M":
                            prob = 0.0
                            age_sex_modifier_applied = "sex_gate: M_only (probability set to 0)"
                    
                    # Apply age gate
                    age_gate = modifier_data.get("age_gate")
                    if age_gate and patient_age is not None:
                        if patient_age < age_gate[0] or patient_age > age_gate[1]:
                            prob = 0.0
                            age_sex_modifier_applied = f"age_gate: [{age_gate[0]}, {age_gate[1]}] (probability set to 0)"
                    
                    # Apply age bracket modifier
                    if patient_age is not None and "age_brackets" in modifier_data:
                        age_brackets = modifier_data["age_brackets"]
                        if patient_age < 40 and "<40" in age_brackets:
                            prob *= age_brackets["<40"]
                            age_sex_modifier_applied = f"age_bracket: <40 (×{age_brackets['<40']})"
                        elif patient_age >= 65 and ">65" in age_brackets:
                            prob *= age_brackets[">65"]
                            age_sex_modifier_applied = f"age_bracket: >65 (×{age_brackets['>65']})"
                        elif "40-65" in age_brackets:
                            prob *= age_brackets["40-65"]
                    
                    # Apply sex modifier
                    if patient_sex in modifier_data.get("sex", {}):
                        sex_mult = modifier_data["sex"][patient_sex]
                        prob *= sex_mult
                        if age_sex_modifier_applied:
                            age_sex_modifier_applied += f", sex: {patient_sex} (×{sex_mult})"
                        else:
                            age_sex_modifier_applied = f"sex: {patient_sex} (×{sex_mult})"
                    
                    break
            
            # Update the probability in hypotheses_data
            hypotheses_data[diagnosis_key]["prob"] = prob
            hypotheses_data[diagnosis_key]["red_flag_applied"] = red_flag_applied
            hypotheses_data[diagnosis_key]["age_sex_modifier_applied"] = age_sex_modifier_applied
        ...
        # Create hypotheses with PROMPT 6 enhancements
        for diagnosis, data in hypotheses_data.items():
            prob = data.get("prob", 0)
            if prob > 0:
                # Get evidence PMIDs for this diagnosis
                diagnosis_lower = diagnosis.lower().replace(" ", "_")
                evidence_pmids = HYPOTHESIS_PMIDS.get(diagnosis_lower, [])
                # Also check for partial matches
                if not evidence_pmids:
                    for key in HYPOTHESIS_PMIDS:
                        if key in diagnosis_lower or diagnosis_lower in key:
                            evidence_pmids = HYPOTHESIS_PMIDS[key]
                            break
                ...
                hypothesis = DiagnosticHypothesis(
                    ...
                    evidence_pmids=evidence_pmids,  # PROMPT 6
                    forced_inclusion=False,
                    red_flag_applied=data.get("red_flag_applied", ""),  # PROMPT 6
                    age_sex_modifier_applied=data.get("age_sex_modifier_applied", ""),  # PROMPT 6
                )
